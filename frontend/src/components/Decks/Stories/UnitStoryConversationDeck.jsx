...
const UnitStoryConversationDeck = ({saynete, lang_img}) => {
    ...
    return (
        ...
        <Link to={{pathname:`/conversation_page/${ctx.current_deck.language_deck.language}`}} >
...
export default UnitStoryConversationDeck