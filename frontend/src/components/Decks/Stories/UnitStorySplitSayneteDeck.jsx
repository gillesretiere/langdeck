...
const UnitStorySplitSayneteDeck = ({saynete, lang_img}) => {
    ...
    return (
        ...
        <Link to={{pathname:`/split_saynete_page/${ctx.current_deck.language_deck.language}`}} >
            <div className={`${classes.card__wrapper}`}>
                ...
                <div className={classes.image_container}>
                  <div className={`${classes.card__img__warhol__effect}`}>
...
export default UnitStorySplitSayneteDeck