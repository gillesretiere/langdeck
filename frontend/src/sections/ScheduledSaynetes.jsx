...
const ScheduledSaynetes = ({saynetes}) => {
    return (
        <>
            <div className='text-xl sm:text-3xl font-artifex_cf font-bold tracking-tight text-gray-900 mt-5' >Prochainement</div>
...
export default ScheduledSaynetes